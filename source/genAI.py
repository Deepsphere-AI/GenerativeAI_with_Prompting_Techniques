...
from source.chatgpt_cheat import Chatgpt_Cheat

def features():
    # creating columns 
    w1,col1,col2,w2=st.columns((0.6,3.9,5.9,0.2))
    ...
    with col2:
        ...
        vAR_app = ["Prompting Techniques",'Language','Vision','Voice']
    ...
    if vAR_input_app == 'Language':
        ...
        if vAR_input_use_case == "GPT-3":
            with col1:
                st.write("## ")
                st.markdown("<p style='text-align: left; color: black; font-size:20px;'><span style='font-weight: bold'>Select the Catogory</span></p>", unsafe_allow_html=True)
            with col2:
                vAR_catogry=st.selectbox("",['Select','Text','Code'])
                if vAR_catogry == "Code":
                    with col1:
                        st.write("## ")
                        # st.write("### ")
                        ...
                        if vAR_code_lang != "Select":
                            ...
                            with col2:
                                ...
                                if problem_statement != "":
                                    ...
                                    st.write("### ")
                                    if st.button("Submit"):
                                        code_1=generate_response3("write a "+vAR_code_lang+" program for this problem statement "+problem_statement)
                                        with cc1:
                                            st.code(code_1)
                elif vAR_catogry == "Text":
                    with col1:
                        st.write("## ")
                        # st.write("### ")
                        ...
                        if vAR_code_lang != "Select":
                            ...
                            with col2:
                                ...
                                if problem_statement != "":
                                    ...
                                    st.write("### ")
                                    if st.button("Submit"):
                                        code_2=generate_response3_5("write a "+vAR_code_lang+" program for this problem statement "+problem_statement)
                                        with cc1:
                                            st.code(code_2)
                elif vAR_catogry == "Text":
                    with col1:
                        ...
                        if vAR_code_lang != "Select":
                            ...
                            with col2:
                                ...
                                if problem_statement != "":
                                    ...
                                    st.write("### ")
                                    if st.button("Submit"):
                                        code_3=generate_response4("write a "+vAR_code_lang+" program for this problem statement "+problem_statement)
                                        with cc1:
                                            st.code(code_3)
                elif vAR_catogry == "Text":
                    with col1:
                ...
                if audio_bytes:
                    ...
                    if st.button("Submit"):
                        ...
                        with cc1:
                            st.write()
                            # Displaying the response
                            st.success(response_5)
    elif vAR_input_app == "Prompting Techniques":
        Chatgpt_Cheat(col1,col2)
