...
st.markdown("<p style='text-align: center; color: black; font-size:23px;'><span style='font-weight: bold'></span> Generative AI: Large Language Model(LLM) - Prompt Engneering</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: blue;margin-top: -10px ;font-size:20px;'><span style='font-weight: bold'></span>Interact with GPT and ChatGPT Models to Learn the Art of Prompt</p>", unsafe_allow_html=True)
